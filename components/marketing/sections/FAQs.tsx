            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3">
                ...
                <AccordionItem value="item-2">
                  ...
                  <AccordionContent>
                    <p>
                      The library follows Webflow&apos;s design system. That
                      reduces errors and makes handoff between design and
                      development teams smoother.
                    </p>
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-3">
                  <AccordionTrigger>
                    <h3>
                      I&apos;m not familiar with WFS. Can I still use this
                      library?
                    </h3>
                  </AccordionTrigger>
                  <AccordionContent>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3">
                <AccordionItem value="item-5">
                  ...
                  <AccordionContent>
                    <p>
                      ...
                      members or publish a UI kit to your team&apos;s Figma
                      library, you&apos;ll need to buy a Team license.
                    </p>
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-8">
                  ...
                  <AccordionContent>
                    <p>
                      Sure! We will reduce your next order&apos;s price by the
                      amount you paid for the Personal license. Please{" "}
                      <a
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3">
                <AccordionItem value="item-14">
                  ...
                  <AccordionContent>
                    <p>
                      If you&apos;re having trouble with shadcn/ui kit for
                      Figma, we&apos;re here to help via email:{" "}
                      <a
                        href="mailto:aleksandar@minimal-square.com"
                        className="fg-base"
                      >
