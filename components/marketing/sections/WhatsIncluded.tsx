...
import { Card, CardList, CardListItem } from "@/components/marketing/ui/Card";
            ...
            <div className="flex flex-col gap-5 text-left">
              ...
              <div className="flex w-full flex-col gap-2">
                ...
                <p className="max-w-[24rem] text-sm leading-6 fg-muted">
                  Leverage Webflow&apos;s design system to skip the basics and
                  dive straight into crafting your app&apos;s features.
                </p>
              </div>
            </div>
          </div>
