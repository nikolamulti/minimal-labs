        ...
        <div className="w-full">
          <Accordion type="single" collapsible className="flex flex-col gap-8">
            <div className="flex flex-col gap-4">
              <h3 className="text-lg font-semibold fg-base">General</h3>
                ...
                <AccordionItem value="item-2">
                  ...
                  <AccordionContent>
                    <p>
                      ...
                      errors and makes handoff between design and development
                      teams smoother.
                    </p>
                  </AccordionContent>
                </AccordionItem>
            ...
            <div className="flex flex-col gap-4">
              <h3 className="text-lg font-semibold fg-base">Licensing</h3>
              <div className="flex flex-col gap-3">
                <AccordionItem value="item-5">
                  ...
                  <AccordionContent>
                    <p>
                      ...
                      <br></br>If you work with someone or a team, you will need
                      a team license.<br></br>
                      <br></br>If you plan to share Figma files with team
                      members or publish a UI kit to your team's Figma library,
                      you'll need to buy a Team license.
                    </p>
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-6">
                  ...
                  <AccordionContent>
                    <p>
                      Yes! You can use the product for an unlimited amount of
                ...
                <AccordionItem value="item-8">
                  ...
                  <AccordionContent>
                    <p>
                      Sure! We will reduce your next order's price by the amount
                      you paid for the Personal license. Please{" "}
                      <a
                ...
                <AccordionItem value="item-9">
                  ...
                  <AccordionContent>
                    <p>
                      No, you're not allowed to sell or distribute the products
                      on your website or marketplaces like ThemeForest, Creative
                      Market, etc. (even for free), as well as resell, lease,
                      license, sublicense or redistribute a purchased product on
                      its own (even for free). You can learn more about
                      licensing on our{" "}
                      <a
                        className="underline fg-base"
            ...
            <div className="flex flex-col gap-4">
              <h3 className="text-lg font-semibold fg-base">
                Payments & Billing
              </h3>
              <div className="flex flex-col gap-3">
                ...
                <AccordionItem value="item-11">
                  ...
                  <AccordionContent>
                    <p>
                      Yes, we provide invoices for all purchases. We sell via
                      our merchant of record Lemon Squeezy and after the
                      purchase you will be able to generate an invoice with all
                ...
                <AccordionItem value="item-12">
                  ...
                  <AccordionContent>
                    <p>
                      We are selling our products via our Merchant of Record -
                      Lemon Squeezy. Their company details will be stated on
                      your invoice after the purchase. Below you can find the
                      Lemon Squeezy details for your accounting:<br></br>
                      <br></br>
                      <span className="fg-base">Name:</span> Lemon Squeezy, LLC
                      <br></br>
                      <span className="fg-base">Address:</span> 222 South Main
                      Street Suite 500, Salt Lake City, UT 84101, USA
                      <br></br>
                      <span className="fg-base">EU VAT number:</span>{" "}
                      EU440000220
                    </p>
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-13">
                  ...
                  <AccordionContent>
                    <p>
                      If your payment fails, the following steps can help get
                      your purchase through:
                      <ul>
                        <li>
                          • Try the purchase in a different browser, or update
                        ...
                        <li>
                          • Call your card provider or contact PayPal and ask
                          them if there are blocks or limitations on your
                          account
                        </li>
                      </ul>
                      <br></br>
                      If you still have problems with getting your payment
            ...
            <div className="flex flex-col gap-4">
              <h3 className="text-lg font-semibold fg-base">Support</h3>
              <div className="flex flex-col gap-3">
                <AccordionItem value="item-14">
                  ...
                  <AccordionContent>
                    <p>
                      If you're having trouble with shadcn/ui kit for Figma,
                      ...
                      <br></br>
                      <br></br>Please note we are not Figma support. If you have
                      a Figma-related question, we recommend checking{" "}
                      <a
                        className="underline fg-base"
                ...
                <AccordionItem value="item-16">
                  ...
                  <AccordionContent>
                    <p>
                      If you have questions, feedback or suggestions, don't
                      hesitate and contact us via email at{" "}
                      <a
                        href="mailto:aleksandar@minimal-square.com"
                        className="fg-base"
                      >
                      ...
                      products, or freebies, follow us on X (formerly Twitter)
                      at{" "}
                      <a
                        className="underline fg-base"
