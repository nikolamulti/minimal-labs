export function InteractionsCircle({
  size = 20,
  ...props
  ...
  return (
    ...
    >
      <path
        d="M8 7V3.5L4.98901 8.23156C4.77718 8.56442 5.01629 9 5.41084 9H8v3.5l3.011-4.73156C11.2228 7.43558 10.9837 7 10.5892 7H8Z"
        fill="currentColor"
      />
      <path
        opacity=".4"
