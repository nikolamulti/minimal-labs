  ...
  (
    ...
    return (
      <figure
        ...
        {...props}
        className={cn(
          "not-prose group fd-codeblock relative my-6 overflow-hidden rounded-lg border bg-fd-secondary text-sm",
          keepBackground &&
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "transition-opacity group-hover:opacity-100 text-fd-muted-foreground",
        !checked && "opacity-0",
        className
      )}
