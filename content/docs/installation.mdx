...
<Steps>
  ...
  <Step>
    ...
    This will enable the global styles required for the components to work properly.
  ...
  <Step>
    ...
    Great! You've successfully installed Webflow Svelte Components. You can now start using the components in your project. Check out the components section to learn how to use them.
