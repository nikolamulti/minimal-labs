...
<svg width={size} height={size} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" {...$$restProps}>
  ...
  <g opacity=".4" fill="currentColor">
    <path
      d="M6 3H3v10h3v-1.5h1V13c0 .5523-.44772 1-1 1H3c-.55228 0-1-.4477-1-1V3c0-.55228.44772-1 1-1h3c.55228 0 1 .44772 1 1v1.5H6V3ZM9 11.5V13c0 .5523.44772 1 1 1h3c.5523 0 1-.4477 1-1V3c0-.55228-.4477-1-1-1h-3c-.55228 0-1 .44772-1 1v1.5h1V3h3v10h-3v-1.5H9Z"
    />
  </g>
</svg>
