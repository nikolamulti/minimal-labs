...
<svg width={size} height={size} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" {...$$restProps}>
  ...
  <path
    fill-rule="evenodd"
    clip-rule="evenodd"
    d="M11.8535 5.85353 7.35352 10.3535c-.09376.0938-.22094.1465-.35355.1465-.13261 0-.25978-.0527-.35355-.1465l-2.5-2.49997.70711-.70711 2.14644 2.14645 4.14643-4.14645.7071.70711Z"
    fill="currentColor"
  />
</svg>
